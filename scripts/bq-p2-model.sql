...
-- Ad fact, with market/targeting parsed out of the JSON blob ------------------
...
-- Mart: brand ad velocity (new launches by the ad's own start_date) -----------
...
SELECT
  ...
  -- velocity weighted by reach — separates real scaling from spray-and-pray
...
-- Mart: share of voice by category & country ---------------------------------
...
-- Mart: creative format mix by category --------------------------------------
...
-- Mart: ingestion health (ads added per day, last 30d) -----------------------
